...
<div className='policy py-5'>
        <div className='container'>
          <h1 className=' fw-bold mb-4 '>Terms & Condition</h1>
          <p>These Terms and Conditions, along with privacy policy or other terms constitute a binding agreement by and between AKCXIS INTERNATIONAL SERVICES,and you and relate to your use of our website, goods or services.</p>
      ...
      <ul>
        ...
        <li>Your use of our Services and the websites solely at your own risk and discretion. You are required to independently assess and ensure that the Services meet your requirements. The contents of the Website and the Services are proprietary to Us and you will not have any authority to claim any intellectual property rights, title, or interest in its contents.</li>
