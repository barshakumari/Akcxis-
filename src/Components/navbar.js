                            ...
                            <ul className="navbar-nav ms-auto pe-4 mb-lg-0 text-uppercase fw-bold">
                                ...
                                <li className="nav-item dropdown active  me-1">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-white p-3">
                                        ...
                                        {/* <li><a className="dropdown-item" href="/EuropeWork">Europe</a></li>
                                        <li><a className="dropdown-item" href="/NzWork">New Zealand</a></li>
                                        <li><a className="dropdown-item" href="/SingaporeWork">Singapore</a></li> */}
                                    </ul>
                                </li>
