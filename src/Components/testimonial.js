                    ...
                    <div className='row g-3'>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-12 '>
                            <div className='border border-dark border-opacity-25 rounded-3 shadow-lg p-3'>
                                ...
                                <p className='text-center text-danger fw-bold'>UK study visa</p>
                                <p >Hello, I'm Urmila. I'm thrilled to share that I've obtained my UK study visa through Akcxis Immigration. Their team provided exceptional support and guidance throughout the process, keeping me motivated and informed every step of the way. Overall, my experience with Akcxis Immigration was outstanding!</p>
                            </div>
                        </div>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-12 '>
                            <div className='border border-dark border-opacity-25 rounded-3 shadow-lg p-3'>
                                ...
                                <p className='text-center text-danger fw-bold'>UK study visa</p>
                                <p>Hey everyone, it's Mandeep Kaur here. I just wanted to share some great news—I got my UK study visa with the awesome support from Akcxis Immigration! They were so helpful and made the whole process easy for me. Now, I can't wait to pursue my dreams in the UK thanks to them! </p>
                            </div>
                        </div>
